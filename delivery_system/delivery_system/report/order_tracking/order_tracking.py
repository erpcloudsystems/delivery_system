...
def get_column():
    return [
        ...
        _("Order Review") + ":Data:150",
        _("Order Processing") + ":Data:150",
        _("Delivery To Shipping Source") + ":Data:180",
        _("Delivery To Customer") + ":Data:150",
    ]


def get_data(conditions, filters):
    invoice = frappe.db.sql(
        """select transaction_date,name, customer_name,  shipping_source, order_review_status, order_processing, delivery_to_shipping_source, delivery_to_customer 
